...
builder.Services.AddSwaggerGen(); // above this is configuration for the "behind the scenes" thing in your API
...
// above this is the configuration for the "behind the scenes" thing in your API
var app = builder.Build(); // after this is setting up "Middleware" - that's the code that receives the HTTP Request and makes the response.
